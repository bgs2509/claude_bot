...
from ai_steward.keyboards import build_paginated_keyboard, build_project_reply_keyboard
from ai_steward.services.storage import SessionStorage

router = Router(name="project_switch")
log = logging.getLogger("ai-steward.project_switch")
...
async def _handle_create(message: Message, state: FSMContext, project_tag: str = "") -> None:
    ...
    from ai_steward.handlers.commands import CreateProject
