"""Точка входа: python -m ai_steward / uv run ai-steward."""

import asyncio
import logging
import sys

from ai_steward import __version__
from ai_steward.bot import create_bot, create_dispatcher
from ai_steward.config import Settings
from ai_steward.logging_setup import setup_logging, setup_sentry
from ai_steward.services.analytics import EventLogger
from ai_steward.services.planner_manager import PlannerManager
from ai_steward.services.storage import SessionStorage
from ai_steward.state import AppState

log = logging.getLogger("ai-steward")
...
async def _run(settings: Settings) -> None:
    ...
    log.info(
        "Startup: service=ai-steward version=%s python=%s users=%d",
